  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-44 overflow-hidden'>
      ...
      <div className='relative flex items-center justify-between pt-20 pb-10'>
        ...
        <p className='text-gray-300 font-mediem tet-lg'>Now Showing</p>
      ...
      <div className='flex justify-center mt-20'>
        ...
        className='px-4 py-2.5 trxt-sm hover:bg-red-500 transition
         bg-red-400 rounded-md font-medium  cursor-pointer'>Show More</button>
